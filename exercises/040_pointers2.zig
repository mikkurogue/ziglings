...
// either changing `const a` to `var a`
// or deferencing the pointer by doing a.*
// or changing `const b` to be of type constant pointer ref of u8 (*const u8)
// interesting i wonder what the best way to do this is
